...
<script src="selection_script.js"></script>
...
<head>
  ...
  <title>PackingLight | Gerar objetos</title>
  ...
  <link rel="stylesheet" href="custom-div.css">
</head>
...
<aside class="main-sidebar">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <h1 style="display: inline-block;"><a href="#">3D</a></h1>
    </section>
      ...
      <div class="register-box"  style="width: 700px">
        ...
        <div class="register-box-body">
          ...
          <form action="../lib/buscaObjeto.php" method="post">
            ...
            <div id="custom-div" class="form-group has-feedback" style="text-align: center;">
              ...
              <div id="select1" class="select-field">
                ...
                <select required name = "nome_obj" id = "setect_obj" style="position: relative; margin:  0 0 4px 180px;">
                  ...
                  <?php while ($row = mysqli_fetch_assoc($listar)) { ?><option value='<?php echo $row['nome'];?>'></option><?php } ?>
                </select>
              </div>
