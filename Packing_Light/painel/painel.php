          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                    <a href="pages/alterar_usuario.php" class="btn btn-default btn-flat">Editar dados</a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
              <li class="active"><a href="pages/cadastro_clientes.php"><i class="fa fa-plus-square-o"></i> Cadastrar cliente</a></li>
              <li><a href="pages/listar_clientes.php"><i class="fa fa-search"></i> Listar clientes</a></li>
              <li><a href="pages/importar_dados.php"><i class="fa fa-upload"></i> Importar dados</a></li>
          </ul>
        </li>
        <!--GERAR ROTAS-->
        <li>
            <a href="pages/gerar_rota.php">
