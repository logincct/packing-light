<?php require_once("../../../lib/admin/cadastro_usuario.php"); ?>
...
<head>
  ...
  <title>LOGIN | Cadastro de usuários</title>
  ...
  <div class="register-box"  style="width: 700px">
    ...
    <div class="register-box-body">
        ...
        <form method="post">
            ...
            <div class="form-group has-feedback">
                <input type="password" class="form-control" placeholder="Confirme a senha" name="senha_confirm" required>
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
