<?php require_once("../lib/listar_clientes.php"); ?>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="myTable1">
                ...
                <tr><td><?php echo $table ['codigo']."   ";?></td> <td><?php echo $table['nome']."   ";?></td> <td><?php echo $table['endereco']."   ";?></td> <td><?php echo $table['email']."   ";?></td> <td><?php echo $table['telefone']."   ";?></td> <td><?php echo $table['data_cadastro']."   ";?></td> <td><?php echo $table['hora_cadastro'];?></td> <td align="center"> <?php echo "<a title='Editar' href=\"../pages/alterar_cliente.php?codigo=$table[codigo]\"><i class='fa fa-edit'></i></a> | <a title='Excluir' href=\"../lib/excluir_cliente.php?codigo=$table[codigo]\" onClick=\"return confirm('Certeza de que quer excluir?')\"><i class='fa fa-times'></i></a></td>" ;?></td> </tr><?php } ?>
