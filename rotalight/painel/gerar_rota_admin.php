        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="cadastro_usuarios.php"><i class="fa fa-plus-square-o"></i> Cadastrar usuário</a></li>
              <li><a href="cadastro_clientes_admin.php"><i class="fa fa-plus-square-o"></i> Cadastrar cliente</a></li>
              <li><a href="listar_usuarios.php"><i class="fa fa-search"></i> Listar usuários</a></li>
              <li><a href="listar_clientes_admin.php"><i class="fa fa-search"></i> Listar clientes</a></li>
              <li><a href="importar_dados_admin.php"><i class="fa fa-upload"></i> Importar dados</a></li>
          </ul>
        </li>
        <!--GERAR ROTAS-->
        <li class="active">
            <a href="gerar_rota_admin.php">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <form  method="post" class="form-group"> 
            ...
            <input type="button" class="btn btn-primary" value="Adicionar entregas" onclick="addCampos()" style="width: 15%">
            ...
            <br>
            <div class="box-body">
            <input type="submit" class="btn btn-block btn-success" onclick="addMark()" value="Gerar rota" style="width: 10%">
            </div>
    ...
    <script type="text/javascript"> 
        ...
        contador++;
            ...
            for(i=0; i<qtdeCampos; i++){
                ...
                document.getElementById("campo"+(i+1)).innerHTML = "<div class = 'box-body'><select class='form-control select2' style = 'width:25%' name='campo"+(i+1)+"' id='campo"+(i+1)+"'><option value=''></option><?php while ($row = mysqli_fetch_assoc($listar)) { ?><option id='pega' value='<?php echo $row['nome'];?>'><?php echo $row['nome']."    ";?></option><?php } ?></select></div><br>";
            }
    ...
    // });
            ...
            function showposition(){
              ...
              var lat=pega.coords.latitude;
  var lon=pega.coords.longitude;
  var latlon=new google.maps.LatLng(lat, lon)
                   //var location = "<?php echo $vetor3[$tamanho_vetor]; ?>";
    ...
    initialize();
        ...
        */
        ...
        // var posicao = new google.maps.LatLng(enderecoChegada.coords.latitude, enderecoChegada.coords.longitude);
        // var opcoes = {
        //   position: posicao
        //   , icon: image
        //   , map: map
