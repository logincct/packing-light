<?php require_once("../../../lib/user/importar_dados.php"); ?>
...
<head>
  ...
  <title>RotaLight | Importar dados</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
              ...
              <li class="active"><a href="importar_dados.php"><i class="fa fa-upload"></i> Importar dados</a></li>
          </ul>
        </li>
        <!--GERAR ROTAS-->
        <li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Importar dados</li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Selecione o arquivo desejado</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
      ...
      <div>
          <a href="../modelo.xlsx" download>Clique aqui para fazer o download do modelo</a>
          <br>
          <a href="../tutorial.pdf" download>Clique aqui para fazer o download do tutorial de como usar o modelo</a>
      </div>
      <!-- /.row -->
    </section>
    <!-- /.content -->
