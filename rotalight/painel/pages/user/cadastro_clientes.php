<?php require_once("../../../lib/user/cadastro_cliente.php"); ?>
...
<head>
  ...
  <title>RotaLight | Cadastro de clientes</title>
...
<div class="wrapper">
  ...
  <div class="register-box"  style="width: 700px">
    ...
    <div class="register-box-body">
        <p class="login-box-msg" style="font-size: large">Cadastrar novo cliente</p>
        ...
        <form method="post">
            ...
            <div class="form-group has-feedback">
                <input type="tel" class="form-control" maxlength="14" OnKeyPress="formatar('(##)#####-####', this)" placeholder="Telefone com DDD e o 9" required name="telefone">
