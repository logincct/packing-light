<?php require_once("../../../lib/user/alterar_cliente.php"); ?>
...
<head>
  ...
  <title>RotaLight | Alterar clientes</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Alterar clientes</li>
      </ol>
    </section>
  ...
  <div class="register-box"  style="width: 700px">
    ...
    <div class="register-box-body">
        <p class="login-box-msg" style="font-size: large">Alterar cliente</p>
        <!-- <form method="post">
            <div class="row" style="padding-bottom: 5%">
                <div class="col-xs-81">
                    <div class="checkbox icheck" style="width: 20%;float:left;margin-left:15px ">
                        <input type="text" class="form-control" placeholder="Código cliente" name="codigo_cliente" required>
                    </div>
                </div>
                
                <div class="col-xs-41" style="width: 10%;float:left;padding-top: 10px;margin-left: 15px">
        ...
        <form id="2" method="post">
            ...
            <div class="form-group has-feedback">
              <label>Código</label>
                <input type="text" class="form-control" placeholder="Código" name="cod_form2" value="<?php if($codigo_cliente != ""){echo $resultado1['codigo'];}?>" readonly="">
                <span class="glyphicon glyphicon-tag form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
              <label>Nome Completo</label>
                <input type="text" class="form-control" placeholder="Nome Completo" name="nome" value="<?php if($codigo_cliente != ""){echo $resultado1['nome'];}?>" required>
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
              <label>Endereço</label>
                <input type="text" class="form-control" placeholder="Endereço" name="endereco" value="<?php if($codigo_cliente != ""){echo $resultado1['endereco'];}?>" required>
                <span class="glyphicon glyphicon-home form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
              <label>Email</label>
                <input type="email" class="form-control" placeholder="Email" name="email" value="<?php if($codigo_cliente != ""){echo $resultado1['email'];}?>" required>
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
              <label>Telefone com DDD e o 9</label>
                <input type="tel" class="form-control" maxlength="14" OnKeyPress="formatar('(##)#####-####', this)" placeholder="Telefone com DDD e o 9" required name="telefone" value="<?php if($codigo_cliente != ""){echo $resultado1['telefone'];}?>">
                <span class="glyphicon glyphicon-phone form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="hidden" class="form-control"  name="data_cadastro" value="<?php date_default_timezone_set('America/Fortaleza'); echo date('Y/m/d');?>" readonly="" required>
            ...
            <div class="row">
                ...
                <div class="col-xs-4" style="width: 20%;float:right">
                    <button type="submit" name="update" class="btn btn-primary btn-block btn-flat">Alterar</button>
                </div>
                <!-- /.col -->
            </div>
        </form>    
