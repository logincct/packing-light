  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Alterar dados do usuário</li>
      </ol>
    </section>
  ...
  <div class="register-box"  style="width: 700px">
    ...
    <div class="register-box-body">
        ...
        <form method="post">
            ...
            <div class="form-group has-feedback">
                <input type="hidden" class="form-control"  name="hora_cadastro1" value="<?php date_default_timezone_set('America/Fortaleza'); echo date('H:i:s');?>" readonly="" required>
